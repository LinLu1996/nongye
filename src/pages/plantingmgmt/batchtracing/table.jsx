        ...
        return (
            <div className='res-table'>
                <LocaleProvider locale={zhCN}>
                    <Table rowKey={record => record.batchNo} columns={this.columns} dataSource={data} pagination={false}/>
                </LocaleProvider>
                <Pagination defaultCurrent={1} current={Curs} total={total} onChange={this.onSizeChangequery.bind(this)} className='XGres-pagination'/>
            </div>
        );
    }
}
