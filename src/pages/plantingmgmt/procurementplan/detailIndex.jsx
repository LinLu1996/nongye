...
import {Button, Table, InputNumber, message, Modal, LocaleProvider,Row,Col,Card} from 'antd';
        ...
        return (
            <div className='res-table'>
                <LocaleProvider locale={zhCN}>
                    <Table rowKey={record => record.taskId} columns={this.columns2}
        ...
        if (this.state.pageType === 'modify') {
            this.columns2.push({
                ...
                render: (text, record) => {
                    ...
                    return <a onClick={this.delete.bind(this, record)}>删除</a>
                    ;
                }
            });
        }
                    ...
                    <div className='content'>
                        <div className='procurement-plan-box'>
                            ...
                            { isEdit &&<div className='content-button-list procurement-plan-button'>
                                ...
                                <Button className={baseInfo.stauts === '进行中' ? 'detail' : 'detail'}
                                        type="primary" onClick={this.cancel.bind(this)}>作废</Button>
                            </div>}
                        </div>
                        {
                            isEdit && <Row style={{marginBottom: '20px'}}>
                                <Col span={24}>
                                    <Button type="primary" onClick={this.addmodel.bind(this)}>添加农资</Button>
                                </Col>
                            </Row>
                        }
                        <div className='res-table'>
                            ...
                            {isEdit ? <div className='content-btm-list content-button-list'>
                                    ...
                                    <NavLink to={'/pages/plantingmgmt/procurementplan/2'}><Button className='detail'>取消</Button></NavLink>
                                </div> :
                                <div className='content-btm-list content-button-list'>
                                    <NavLink to={'/pages/plantingmgmt/procurementplan/2'}><Button className='detail'>返回</Button></NavLink>
                                </div>
                            }
                        </div>
