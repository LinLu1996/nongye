...
import {Card, Row, Col, Button, Select, DatePicker, Modal, LocaleProvider, Form, Icon} from 'antd';
...
class AnalyzeBar extends Component {
    ...
    renderAdvancedForm() {
        const { baseList,landList,cropList } = this.state;
        const dateFormat = 'YYYY-MM-DD';
        const date = new Date();
        date.setMonth(date.getMonth() - 3);
        const newBaseList = [];
                    ...
                    <div className='tableList'>
                            ...
                            </Row></div>}
                        {
                            ...
                            <Card className='analyze-chart white-card' style={{marginBottom: '20px'}}>
                                <div className='table-header analyze-bottom'>
                                    ...
                                    {(this.state.showChartsType === 'watering' || this.state.showChartsType === 'wateringTimes') ?
                                        <p><Button
                                            className={this.state.showChartsType === 'wateringTimes' ? 'btn-common red-btn' : 'btn-common'}
                                            onClick={this.handleChangeWater.bind(this, 1)}>灌溉次数</Button>
                                            <Button
                                                className={this.state.showChartsType === 'watering' ? 'btn-common red-btn' : 'btn-common'}
                                                onClick={this.handleChangeWater.bind(this, 0)}>灌溉量</Button></p> : <p><Button
                                            className={this.state.showChartsType === 'fertilizationTimes' ? 'btn-common red-btn' : 'btn-common'}
                                            onClick={this.handleChangeWater.bind(this, 1)}>施肥次数</Button>
                                            <Button
                                                className={this.state.showChartsType === 'fertilization' ? 'btn-common red-btn' : 'btn-common'}
...
const WrappedNormalLoginForm = Form.create()(AnalyzeBar);
