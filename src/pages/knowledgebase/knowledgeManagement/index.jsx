...
import {Input, Button, message, Pagination, Modal, LocaleProvider, Card, Form, Row, Col, Divider} from 'antd';
                    ...
                    <div className='tableList'>
                        <div className='tableListForm'>{this.renderForm()}</div>
                        {
                            ...
                            <Row style={{marginBottom: '20px'}}>
                                <Col span={24}>
                                    <Button type="primary" onClick={this.addKnowledge.bind(this)}>新增知识</Button>
                                </Col>
                            </Row>
                        }
                                        ...
                                        Alldate.length>0 && Alldate.map((item) => {
                                            return <div className='knowledge-result' key={item.id}>
                                                ...
                                                {(editRole) && <div className='knowledge-result-right'>
                                                    <a onClick={this.handleDelete.bind(this,item.id)}>
                                                        删除
                                                    </a>
                                                    <span>
                                                            <Divider type="vertical"/>
                                                            <a onClick={this.handleEdit.bind(this,item.id)}>编辑</a>
                                                        </span>
                                                </div>}
                                            </div>;
                                        })
...
const mapStateprops = (state) => {
 ...
 const WrappedNormalLoginForm = Form.create()(KnowledgeManagement);
