...
class KnowledgeManagement extends Component {
    ...
    render() {
        const {allLabel,fileName} = this.state;
        const _this=this;
        const propsUpload = {
            name: 'files',
            accept:'.avi,.mp4',
            ...
            <div className='farming-box addKnowledge-box'>
                ...
                <div className='content'>
                        ...
                        <div className='content-list'>
                            <div>
                                ...
                                <div className='list-label'>
                                    ...
                                    <Button type="primary" onClick={this.addLabel.bind(this)}>添加标签  +</Button>
                                </div>
                            </div>
                            <div className='list-label-limit'>标签添加不能超过5个</div>
                        </div>
                        <div className='content-list'>
                                    ...
                                    <div className='list-video-top'>
                                        <div className='list-video-t'>
                                            <Upload {...propsUpload} showUploadList={false}>
                                                <Button type="primary" disabled={!this.state.canUpload}>点击上传视频</Button>
                                            </Upload>
                    ...
                    <div className='addKnowledge-bottom'>
                        <Button type="primary" onClick={this.handleUpload.bind(this)} style={{marginRight:'20px'}}>确认</Button>
