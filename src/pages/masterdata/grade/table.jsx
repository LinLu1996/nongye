import {Table, Pagination, message, Switch, LocaleProvider, Divider} from 'antd';
            ...
            this.columns.push({
                ...
                render: (text, record) => {
                    return <div>
                        ...
                        <a onClick={this.addGrade.bind(this, record)}>新增</a>
                        /*<Tooltip title="新增作物等级">
    ...
    expandedRowRender(record) {
        ...
        if (this.props.gradeEditRole) {
            columns.push({
                ...
                align: "center",
                render: (text, record) => {
                    return <a onClick={this.queryGrade.bind(this, record)}></a>;
                    /*<div>
        ...
        return (
            ...
            <Table  rowKey={record => record.id} pagination={false}
                   columns={columns}
    ...
    render() {
        ...
        return (
            <div className='res-table'>
                <LocaleProvider locale={zhCN}>
                {gradeQueryRole ?
                    <Table   className="components-table-demo-nested" rowKey={record => record.id} columns={this.columns}
