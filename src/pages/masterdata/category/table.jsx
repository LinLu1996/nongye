import {Table, Pagination, message, Switch, Divider, LocaleProvider } from 'antd';
                ...
                render: (text, record) => {
                    return <div>
                        {this.props.gradeAddRole &&
                            <a onClick={this.addSmallClass.bind(this, record)}>添加</a>
    ...
    expandedRowRender(record) {
        ...
        if (this.props.gradeEditRole) {
            columns.push({
                ...
                align: "center",
                render: (text, record) => {
                    return <a onClick={this.querySmallClass.bind(this, record)}>编辑</a>;
        ...
        return (
            <div className='res-table'>
                ...
                {gradeQueryRole ?
                 ...
                 <LocaleProvider locale={zhCN}><Pagination className='XGres-pagination' showSizeChanger showQuickJumper onShowSizeChange={this.onShowSizeChange.bind(this)}  onChange={this.onSizeChangequery.bind(this)} current={Cur} defaultCurrent={1}  total={total} /></LocaleProvider></div>
        );
    }
}
