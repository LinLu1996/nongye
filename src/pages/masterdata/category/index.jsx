...
import {Input, Button, message, Col, Row, Card, Form} from 'antd';
        ...
        return (
            <Form layout="inline">
                <Row gutter={{md: 8, lg: 24, xl: 48}}>
                    <Col md={8} sm={24}>
                        <FormItem label="大类名称">
                            <Input value={this.state.name} onChange={this.setBaseName.bind(this)}/>
                        </FormItem>
                    </Col>
                    ...
                    <div className='content categoryContent'>
                        ...
                        {addRole && <Row style={{marginBottom: '20px'}}>
                            <Col span={24}>
                                {
                                    addRole &&
                                    <Button type="primary" onClick={this.addmodel.bind(this)}>新增作物分类</Button>
                                }
                            </Col>
                        </Row>}
                        {/*<div className='table-header'>*/}
                        {/*<p><i className='iconfont icon-sort'></i><span>作物分类列表</span></p>*/}
                        {/*{addRole && <p><Button onClick={this.addmodel.bind(this)}>新增作物分类</Button></p>}*/}
                        {/*</div>*/}
