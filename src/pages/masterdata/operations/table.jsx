        ...
        if(this.props.editRole) {
            this.columns.push({
                ...
                render: (text, record) => {
                    return <div>
                        {record.workTypeId !== 5 ?
                            <a onClick={this.query.bind(this,record)}>编辑</a> : <span>不可编辑</span>}
                    </div>;
                    /*<Tooltip title="编辑">
        ...
        return (
            <div className='res-table'>
                <LocaleProvider locale={zhCN}>
                    <Table  rowKey={record => record.id} columns={this.columns}  dataSource={keyData} pagination={false}/></LocaleProvider>
