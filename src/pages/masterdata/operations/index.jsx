...
import {Input, Button, Select, message, Col, Row, Card, Form} from 'antd';
                ...
                <Card>
                    <div className='content'>
                        ...
                        {addRole && <Row style={{ marginBottom : '20px'}}>
                            <Col span={24}>
                                {addRole && <Button type="primary" onClick={this.addmodel.bind(this)}>新增农事操作</Button>}
                            </Col>
                        </Row>}
