import {Table, Pagination, InputNumber, message,LocaleProvider} from 'antd';
        ...
        if(this.props.editRole && this.props.gradeQueryRole) {
            this.columns.push({
                ...
                render: (text, record) => {
                    ...
                    return <div>
                        {editFlag &&
                            <a onClick={this.saveChange.bind(this, record)}>保存</a>
                        /*<Tooltip title="保存预估产量"><span className='cursor' onClick={this.saveChange.bind(this, record)}><Icon type="save"/></span></Tooltip>*/
                        }
                        {!editFlag &&
                            <a onClick={this.isEditFlag.bind(this, record)}>编辑</a>
                        /*<Tooltip title="编辑预估产量"><span className='cursor' onClick={this.isEditFlag.bind(this, record)}><i
    ...
    render() {
        ...
        return (
            <div className='res-table'>
                <LocaleProvider locale={zhCN}>
                {gradeQueryRole ? <Table  className="components-table-demo-nested" rowKey={record => record.id} columns={this.columns}
                       dataSource={data} expandedRowRender={this.expandedRowRender.bind(this)} pagination={false} expandedRowKeys={expendKeys}
                       onExpand={this.onExpand.bind(this)}/>:<Table  className="components-table-demo-nested" rowKey={record => record.id} columns={this.columns}
                                                                    dataSource={data} />}
                </LocaleProvider>
