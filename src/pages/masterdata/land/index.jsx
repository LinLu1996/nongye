...
import {Input, Button, message, Select, Form, Card, Col, Row, Icon} from 'antd';
        ...
        return (
            <Form layout="inline">
                <Row gutter={{md: 8, lg: 24, xl: 48}}>
                    ...
                    <Col md={8} sm={24}>
                        <FormItem label="所属基地">
                            <Input value={this.state.address} onChange={this.setAddress.bind(this)}/>
                        </FormItem>
                    </Col>
                    ...
                    <div className='content'>
                        ...
                        {addRole && <Row style={{marginBottom: '20px'}}>
                            <Col span={24}>
                                {
                                    addRole &&
                                    <Button type="primary" onClick={this.addmodel.bind(this)}>新增地块</Button>
                                }
                            </Col>
                        </Row>}
