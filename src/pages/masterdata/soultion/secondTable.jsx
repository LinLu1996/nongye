import {Select, InputNumber, Table, Tooltip, Divider} from 'antd';
...
class Tables extends Component {
    constructor(props) {
        ...
        this.columns = [{
            ...
            render: (text, record,index) => {
                return <div>
                    <Select disabled={disOr} style={{width:"100px",marginLeft:"9px"}}  value={record.periodId}
            ...
            render: (text, record,index) => {
                return <div>
                    <Select disabled={disOr} style={{width:"100px",marginLeft:"9px"}}  value={record.workTypeId}
            ...
            render: (text, record,index) => {
                return <div>
                    <Select disabled={disOr} style={{width:"100px",marginLeft:"9px"}}  value={record.operationId}
            ...
            render: (text, record,index) => {
                return <div>
                    <Select disabled={disOr} style={{width:"130px",marginLeft:"9px"}}  value={record.materialId}
        ...
        if(!disOr) {
            this.columns.push({
              ...
              render: (text, record,index) => {
                return <div>
                    <a onClick={this.deleteRecord.bind(this,index,record)}>删除</a>
                    <Divider type="vertical" />
                    <a onClick={this.copy.bind(this,index,record)}>拷贝</a>
                  </div>;
                  /*<div>
