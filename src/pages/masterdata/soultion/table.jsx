import {Table, Pagination, Switch, LocaleProvider, Divider} from 'antd';
        ...
        if(this.props.editRole||this.props.getRole) {
            this.columns.push({
                ...
                render: (text, record) => {
                    return <div>
                        {this.props.editRole &&
                            <NavLink to={`/pages/masterdata/soultion/one/${record.id}/modify`}>编辑</NavLink>
                            /*<Tooltip title="编辑">
                        ...
                        {this.props.editRole && this.props.getRole && <Divider type="vertical" />}
                        {this.props.getRole &&
                            <NavLink to ={`/pages/masterdata/soultion/one/${record.id}/detail`}>详情</NavLink>
                            /*<Tooltip title="查看详情">
