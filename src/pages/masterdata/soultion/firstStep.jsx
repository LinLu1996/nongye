            ...
            <div className='step-layout'>
                <div className='form-layout'>
                        ...
                        <div className='form-col solution-form-col'>
                            <span className='label-title solution-label-title'>方案名称</span>
                            {
                                actionType === 'add' || actionType === 'modify' ?
                                    <Input className='solution-name-input' value={name} onChange={this.setName.bind(this)} onBlur={() => {
                    ...
                    <div className='form-row clearfix'>
                        ...
                        {actionType === 'add' && <div>
                            <Button type="primary" className='form-btn' onClick={this.editCycle.bind(this)}>编辑周期</Button>
                        </div>}
                    </div>
                    <div className='form-row clearfix'>
                    ...
                    <div className='form-row clearfix'>
                        <div className='form-label'>周期时长
                            <div className='question-icon'>
                                <Tooltip placement="right" title="请输入该周期最大时长"><Icon type="question-circle" theme="filled"/></Tooltip>
                            </div>
                        </div>
                    ...
                    <div className='form-title'><i className='iconfont icon-sort'></i>农事任务列表
                        {(this.props.setType === 'modify' || this.props.setType === 'add') &&
                        <Button type="primary" className='form-btn add-task' onClick={this.addTask.bind(this)}>新增任务</Button>}
                    </div>
                    <LocaleProvider locale={zhCN}>
                        <Tables setType={this.props.setType} selectedRowIndex={selectedRowIndex} cycleList={cycleList}
                ...
                <div className='step-foot'>
                    <Button type="primary" onClick={this.setNextStep.bind(this)}>下一步</Button>
                </div>
