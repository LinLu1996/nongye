...
class modifyModal extends Component {
        ...
        this.columns1 = [
            {
                ...
                width: 300,
                render:(text,record) => {
                    if(record && record.approveAttr==='img') {
                        text.map((item,index) => {
                            item.uid=index;
                        });
                ...
                render: (text, record,index) => {
                    let flag = false;
                    if (record && record.approveStatus === 1) {
                        flag = true;
                    } else {
                        flag = false;
                    }
    ...
    componentDidMount() {
        this.setState({
            detailInfo:this.props.currentTable || []
        });
    }
    ...
    hideModal() {   //点击确定的回调
        ...
        const {detailInfo,dataAll,submitFlag} = this.state;
        const vm = {
            id: dataAll.id,
            name: dataAll.name,
                ...
                <div className='farming-admin-modal-mask'>
                    <div className='farming-admin-modal-examine' style={{width: '1000px'}}>
                        <div className='ant-modal-header'>
                            <div><span className='title'>企业信息审核</span><img src={src}/></div>
                        ...
                        <div className='ant-modal-body enterprise-modal-body'>
                            <div className='enterprise-modal-body-table'>
                                ...
                                <Table rowKey={record => record && record.id} columns={this.columns1}
