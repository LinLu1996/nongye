import {Table, Pagination, LocaleProvider, Switch, Input, Button, Icon, message} from 'antd';
...
class Tables extends Component {
    constructor(props) {
        ...
        this.columns = [{
            ...
            align: "center",
            render: (text, record) => {
                const value = record.approveStatus === 0 ? '审核' : '查看';
                return <a onClick={this.checkPerson.bind(this, record)}>{value}</a>;
            }
        }];
        this.detailColumns = [{
            title: '名称',
    ...
    hideModal() {
        const {detailData, detailInfo,submitFlag} = this.state;
            ...
            <div>
                <div className='res-table'>
                    <LocaleProvider locale={zhCN}>
                        <Table rowKey={record => record.id} columns={this.columns} dataSource={dataList}
                ...
                {modalFlag && <div className='farming-admin-modal-mask'>
                    <div className='farming-admin-modal-examine' style={{width: '800px'}}>
                        ...
                        <div className='ant-modal-body'>
                            <Table rowKey={record => record.id} columns={this.detailColumns}
