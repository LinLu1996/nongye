...
import {Select, Card, Form, Row, Col, Button} from 'antd';
...
class Resources extends Component {
    ...
    async initData() {
        ...
        const go = [];
        const ent = [];
        const stateYear = this.state.year === ''?0:this.state.year;
        // await IOModel.PoorListByMonth({year: this.state.year,companyId: 1}).then((res) => {
        await IOModel.PoorListByMonth({year: stateYear,companyId: 1}).then((res) => {
                    ...
                    <div className='tableListForm'>{this.renderForm()}</div>
                    {
                        queryRole && flag === true && <div> <div id="ProjectBar" className='Project' ref={el => (this.el = el)}
                            ...
                            <div className='yield-analysis-connent'>
                                ...
                                {/*<p><span className='hidden-content download-icon' onClick={this.downloadAnalysis.bind(this)}><Icon*/}
