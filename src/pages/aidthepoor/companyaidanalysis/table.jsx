...
const mapstateprops = (state) => {
    const {total, Cur, Alldate, sumDuration, sumPay, Psize, deleteOK, chooseflag, parentname, TreeD, slideID, chooseSIZE, chooseCUR} = state.enterPrisePovertyAnalysisReducer;
    return {
        total: total,
