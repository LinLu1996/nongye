...
import {Input, Button, DatePicker, Select, LocaleProvider, Col, Row, Card, Form, Icon} from 'antd';
        ...
        return (
            <Form layout="inline">
                <Row gutter={{md: 8, lg: 24, xl: 48}}>
                    ...
                    <Col md={8} sm={24}>
                        <FormItem label="涉贫农户">
                            <Input value={this.state.userName} onChange={this.setFarmName.bind(this)}/>
                        </FormItem>
                    </Col>
                    <Col md={8} sm={24} style={{textAlign: 'right'}}>
                        <span className='submitButtons'>
                          <Button type="primary" htmlType="submit" onClick={this.refreshDate.bind(this)}>
                            查询
                          </Button>
                    ...
                    {queryUserRole && <div className='content'>
                        <div className='farmtable'>
                            <Row style={{marginBottom: '20px'}}>
                                <Col span={24}>
                                    {downloadRole &&  <div><Button className='hidden-content'>下载</Button></div>}
                                </Col>
                            </Row>
