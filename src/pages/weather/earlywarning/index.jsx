                ...
                <Card bordered={false}>
                    <div className='content'>
                        <div className='early-warning-table'>
                            <div className='table-header' style={{backgroundColor: '#FFFFFF'}}>
                        ...
                        <div className='early-warning-table'>
                            ...
                            {addRole && <Row style={{marginBottom: '20px'}}>
                                <Col span={24}>
                                    {addRole && <NavLink to={'/pages/weather/earlywarning/add/-1/add'}><Button type="primary">新增预警</Button></NavLink>}
                                </Col>
                            </Row>}
