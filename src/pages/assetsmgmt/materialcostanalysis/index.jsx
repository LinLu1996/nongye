...
import {DatePicker, Select, Icon, Col, Row, LocaleProvider, Card, Form, Button} from 'antd';
...
class Resources extends Component {
    ...
    renderSimpleForm() {
        const { baseId,landId } = this.state;
        const { baseList,landList } = this.props;
        const newBaseList = [];
                ...
                <Row gutter={{md: 8, lg: 24, xl: 48}}>
                    ...
                    <Col md={8} sm={24} style={{textAlign: 'right'}}>
                        <span className='submitButtons'>
                          <Button type="primary" onClick={this.hunsubmit.bind(this)}>
                            查询
                          </Button>
    ...
    renderAdvancedForm() {
        const { baseId,landId,cropId } = this.state;
        const { baseList,landList,cropList } = this.props;
        const newBaseList = [];
        newBaseList.push({id: -1, name: '全部'});
        baseList.forEach((item) => {
            newBaseList.push(item);
    ...
    render() {
        ...
        const {queryFlag, currentIndex, flag} = this.state;
                    ...
                    <div className='tableList'>
                        ...
                        {queryRole && <div className='content'>
                            <div className='matable'>
                                ...
                                {/*</div>*/}
                                {
                                    currentIndex === 1 && <Tables scroll={{x:1200}} rowKey={record => record.id} data={Alldate.report} baseId={this.state.base} landId={this.state.landId} cropId={this.state.cropId}
                                ...
                                {
                                    currentIndex === 2 && <Tables scroll={{x:1200}}  rowKey={record => record.id} data={Alldate.report} baseId={this.state.base} landId={this.state.landId} cropId={this.state.cropId}
                                                                  onSizeChangequery={this.onSizeChangequery.bind(this)}
                                                                  onShowSizeChange={this.onShowSizeChange.bind(this)}
                                                                  onchooseChange={this.onchooseChange.bind(this)}
                                                                  props={this.props}
                                ...
                                {
                                    currentIndex === 3 && <Tables scroll={{x:1200}} rowKey={record => record.id} data={Alldate.report} baseId={this.state.base} landId={this.state.landId} cropId={this.state.cropId}
                                                                  onSizeChangequery={this.onSizeChangequery.bind(this)}
                                                                  onShowSizeChange={this.onShowSizeChange.bind(this)}
                                                                  onchooseChange={this.onchooseChange.bind(this)}
                                                                  props={this.props}
                                ...
                                {
                                    currentIndex === 4 && <Tables scroll={{x:1200}} rowKey={record => record.id} data={Alldate.report} baseId={this.state.base} landId={this.state.landId} crops={this.state.cropId}
                                                                  onSizeChangequery={this.onSizeChangequery.bind(this)}
                                                                  onShowSizeChange={this.onShowSizeChange.bind(this)}
                                                                  onchooseChange={this.onchooseChange.bind(this)}
                                                                  props={this.props}
