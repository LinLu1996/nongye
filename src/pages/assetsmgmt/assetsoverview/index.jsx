...
import {Icon, Row, Col, Progress, Table, Select, Pagination, LocaleProvider, Card, Form, Button} from 'antd';
...
class Resources extends Component {
                ...
                <Row gutter={{md: 8, lg: 24, xl: 48}}>
                    ...
                    <Col md={16} sm={24} style={{textAlign: 'right'}}>
                        <span className='submitButtons'>
                          <Button type="primary" onClick={this.queryChange.bind(this)}>
                            查询
                          </Button>
                          <Button style={{marginLeft: 8}} onClick={this.resetChange.bind(this)}>
                            重置
                          </Button>
                        </span>
                    </Col>
    ...
    renderSimpleForm() {
        const { cropList,landList } = this.state;
        const newCropList = [];
            ...
            <Form layout="inline">
                <Row gutter={{md: 8, lg: 24, xl: 48}} style={{marginTop: '20px'}}>
                    ...
                    <Col md={8} sm={24} style={{textAlign: 'right'}}>
                        <span>
                          <Button type="primary" onClick={this.queryData.bind(this)}>
                            查询
                          </Button>
    ...
    render() {
        ...
        return (
            <div className='asset farming-box'>
                <Card bordered={false}>
                    <div className='tableList'>
                        ...
                        {queryRole && <div className='yield-analysis-connent asset-analysis-connent' style={{margin: '0'}}>
                            <Row gutter={16} className='table-row' style={{marginBottom: '20px'}}>
                                <Col className="gutter-row" span={12} style={{padding:'0 10px'}}>
                                    <div className="gutter-box">
                            ...
                            <div className='tableList'>
                                ...
                                <Tables data={Alldate} rowKey={record => record.key}
