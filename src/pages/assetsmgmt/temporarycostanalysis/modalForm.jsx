            ...
            <Form layout="inline">
                ...
                <div className='tem-table'>
                    <LocaleProvider locale={zhCN}>
                        <Table rowKey={record => record.employeeName} columns={columns} dataSource={props.dataList.value} pagination={false}/>
                    </LocaleProvider>
                </div>
                <div className='tem-table'>
                    <LocaleProvider locale={zhCN}>
                        <Table className='tem-table' columns={columns1} dataSource={props.countList.value} pagination={false}/>
                    </LocaleProvider>
                </div>
        </div>
    );
